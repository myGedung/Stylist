<?php
namespace myGedung\Stylist;

use Cache;
use Config;
use myGedung\Stylist\Html\ThemeHtmlBuilder;
use myGedung\Stylist\Theme\Loader;
use myGedung\Stylist\Theme\Stylist;
...
class StylistServiceProvider extends AggregateServiceProvider
{
    ...
    private function registerAliases()
    {
        ...
        $aliasLoader->alias('Stylist', 'myGedung\Stylist\Facades\StylistFacade');
        $aliasLoader->alias('Theme', 'myGedung\Stylist\Facades\ThemeFacade');

        $this->app->alias('stylist', 'myGedung\Stylist\Theme\Stylist');
    }
    ...
    {
        $this->commands(
            'myGedung\Stylist\Console\PublishAssetsCommand'
        );
    }
